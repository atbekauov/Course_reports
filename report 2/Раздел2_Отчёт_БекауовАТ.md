...
На предыдущем слайде был видеурок, в котором рассказывалось о том, что сервер нужен для всех 4-х перечисленных целей
...
На предыдущем слайде видеоурок, в нём ответ на этот вопрос.
...
Это задание я не выполнил.

![Задание 19](image/19.png){#fig:019 width=70%}

Ответ в Видеоуроке на предыдущей странице.
